...
private:
    ...
    void createInstance() {
        ...
        // Next line is for macOS compatibility only
    ...
    void createTextureSampler() {
        ...
        // Can use lower value for better performance
    ...
    void loadModel() {        
        ...
        bool result = tinyobj::LoadObj(
            ...
            &warn,
            &err,
            (std::string(__PE_MODELS_DIR) + "/viking_room.obj").c_str()
        );
   ...
   void createDescriptorPool() {
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        // Order here should be identical to order of attachments
